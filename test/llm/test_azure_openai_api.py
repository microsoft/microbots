"""
Unit tests for AzureOpenAIApi class
"""
import pytest
import json
import sys
...
@pytest.mark.unit
class TestAzureOpenAIApiInitialization:
    """Tests for AzureOpenAIApi initialization"""
    ...
    def test_init_with_token_provider_creates_azure_client(self):
        ...
        with patch('microbots.llm.azure_openai_api.api_key', None), \
             patch('microbots.llm.azure_openai_api.AzureOpenAI') as mock_azure:
            api = AzureOpenAIApi(system_prompt="test", token_provider=mock_provider)
...
@pytest.mark.unit
class TestAzureOpenAIApiClearHistory:
    """Tests for AzureOpenAIApi.clear_history method"""
...
@pytest.mark.unit
class TestAzureOpenAIApiInheritance:
    """Tests to verify AzureOpenAIApi correctly inherits from LLMInterface"""

    def test_openai_api_is_llm_interface(self):
        """Test that AzureOpenAIApi is an instance of LLMInterface"""
        system_prompt = "You are a helpful assistant"
        api = AzureOpenAIApi(system_prompt=system_prompt)
    ...
    def test_openai_api_implements_ask(self):
        """Test that AzureOpenAIApi implements ask method"""
        system_prompt = "You are a helpful assistant"
        api = AzureOpenAIApi(system_prompt=system_prompt)
    ...
    def test_openai_api_implements_clear_history(self):
        """Test that AzureOpenAIApi implements clear_history method"""
        system_prompt = "You are a helpful assistant"
        api = AzureOpenAIApi(system_prompt=system_prompt)
...
@pytest.mark.unit
class TestAzureOpenAIApiEdgeCases:
